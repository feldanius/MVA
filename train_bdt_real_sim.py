...
variables = ["jj_m", "cosTheta_miss", "missingEnergy_energy_fixed", "missing_p_fixed"]
weight_sf = 1e9

# Archivos de señal y fondo
signal_files = [
    "/eos/user/f/fdmartin/FCC365_MVA_train_realsim/preselection/wzp6_ee_nuenueH_Hbb_ecm365.root",
    "/eos/user/f/fdmartin/FCC365_MVA_train_realsim/preselection/wzp6_ee_numunumuH_Hbb_ecm365.root"
]

background_files = [
    "/eos/user/f/fdmartin/FCC365_MVA_train_realsim/preselection/p8_ee_ZZ_ecm365.root",
    "/eos/user/f/fdmartin/FCC365_MVA_train_realsim/preselection/p8_ee_WW_ecm365.root", 
    "/eos/user/f/fdmartin/FCC365_MVA_train_realsim/preselection/p8_ee_tt_ecm365.root",
    "/eos/user/f/fdmartin/FCC365_MVA_train_realsim/preselection/wzp6_ee_numunumuH_Hbb_ecm365.root"
]
...
pickle.dump(save, open("/eos/user/f/fdmartin/FCC365_MVA_train_realsim/train/bdt_model_example.pkl", "wb"))
