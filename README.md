...
# --- Configuración ---
input_file = 'nuisances_data.txt' # Asume que está en el mismo directorio que el script

# Directorio donde quieres guardar el gráfico
output_directory = "/eos/user/f/fdmartin/FCC365_MVA_train_realsim_recoil/higgs_combine/combine_recoil/mva_0_ZH_w3"
# Nombre del archivo PDF
output_filename = 'mi_grafico_de_impacto.pdf'
