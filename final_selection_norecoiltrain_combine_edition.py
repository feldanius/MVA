...
inputDir   = "/eos/user/f/fdmartin/FCC365_MVA_train_realsim/preselection_total_with_inference_no_recoil_train_apri"

#Input directory where the files produced at the pre-selection level are
#Optional: output directory, default is local running directory
#outputDir   = f"outputs/FCCee/higgs/mass-xsec/final_selection/{flavor}/"
outputDir   = "/eos/user/f/fdmartin/FCC365_MVA_train_realsim/higgs_combine/final_selection/MVA_0"
...
sel0 = "(mva_score[0] >= 0)"
sel1 = "(hbb_p < 90)"
sel2 = "(missingEnergy_energy_fixed > 190)"
cutList = {
    "sel0": f"{sel0}",
    "sel1": f"{sel0} && {sel1}",
