...
outputDir   = "/eos/user/f/fdmartin/FCC365_MVA_train_realsim_recoil/preselection_total_with_inference"
...
###############################################################################################################################################
      # Eliminate particles that correspond to muons y electrons
        ...
        if doInference:
            tmva_helper = TMVAHelperXGB("/eos/user/f/fdmartin/FCC365_MVA_train_realsim_recoil/train/bdt_model_example.root", "bdt_model") # read the XGBoost training
