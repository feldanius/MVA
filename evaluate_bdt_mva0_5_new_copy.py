...
parser.add_argument("-i", "--input", type=str, default="outputs/FCCee/higgs/mva/test_2_pkl/bdt_model_example.pkl", help="Input pkl file")
parser.add_argument("-o", "--outDir", type=str, default="outputs/FCCee/higgs/mva/plots_evaluate_0_5_new", help="Output directory")
...
def plot_kinematics_threshold():
    ...
    kinematics = ['jj_m', 'cosTheta_miss', 'missingEnergy_energy', 'missing_p']
