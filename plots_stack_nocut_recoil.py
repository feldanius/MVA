...
energy         = 365.0
collider       = 'FCC-ee'
#inputDir       = "/eos/user/f/fdmartin/FCC365_MVA_train_realsim_recoil/final_selection/mva_0_5"
#inputDir       = "/eos/user/f/fdmartin/FCC365_MVA_train_realsim_recoil/final_selection/mva_0_2"
inputDir       = "/eos/user/f/fdmartin/FCC365_MVA_train_realsim_recoil/final_selection/mva_total"
formats        = ['png','pdf']
#outdir         = "/eos/user/f/fdmartin/FCC365_MVA_train_realsim_recoil/plots/plots_0_5"
#outdir         = "/eos/user/f/fdmartin/FCC365_MVA_train_realsim_recoil/plots/plots_0_2"
outdir         = "/eos/user/f/fdmartin/FCC365_MVA_train_realsim_recoil/plots/plots_no_mva_cut"
yaxis          = ['lin','log']
stacksig       = ['nostack']
plotStatUnc    = True
